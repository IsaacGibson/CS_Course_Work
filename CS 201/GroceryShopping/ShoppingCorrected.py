...
if (budget >= 40):
    ...
    print("Come on fat ASS You overspent!!!!! put some items back on the shelf BITCH!");
#A piece of the program that writes a certain code if conditions that are set meet their specifications.
#If budget is greater than or equal to 40, write "Buy more food"
#If budget is greater than or equal to 20 and less than or equal to 40, write "Good Job"
#If budget is greater than or equal to 0 and  less than or equal to 20, write "You overspent, make it last"
#If anything else, write "You overspent put some items back"
